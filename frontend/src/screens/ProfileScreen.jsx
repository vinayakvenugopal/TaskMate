...
const PROFILE_IMAGE_DIR_PATH = 'http://localhost:2000/UserProfileImages/'
  ...
  return (
    <FormContainer>
        ...
        <img
          ...
          alt={userInfo.name}
          className="w-36 h-36 rounded-full bg-cover bg-center ml-48 block border-2 border-gray-500"
          // style={{
          //   width: "150px",
          //   height: "150px",
          //   borderRadius: "50%",
      ...
      <Form.Group className="my-2" controlId="name">
        ...
        <Button type="submit" className="mt-3 bg-gray-800 hover:bg-gray-800">
            Update
        </Button>
